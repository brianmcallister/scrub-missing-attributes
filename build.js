...
/***/ function(module, exports, __webpack_require__) {
	...
	Backbone.ajax = function (args) {
	  return args.success.call(undefined, data);
	};

	var _fetch = Backbone.Model.prototype.fetch;
	var _parse = Backbone.Model.prototype.parse;
	var opts = {};
	...
	var fetch = function fetch(event) {
	  var scrub = false;
	...
	var render = function render() {
	  ...
	  var html = '';
	  var el = document.querySelector('.results-list');
